...
std::vector<std::pair<long long,long long>> findGalaxies(const std::vector<std::string>& galaxyMap)
{
    std::vector<std::pair<long long,long long>> galaxyCoordinates;
...
std::vector<std::pair<long long,long long>> expandUniverse(const std::vector<std::pair<long long,long long>>& galaxyCoordinates, const std::vector<std::vector<int>>& emptyRowsAndColumns, int expansionParameter = 1000000-1)
{
    // Initialize output vector
    std::vector<std::pair<long long,long long>> expandedGalaxyCoordinates {galaxyCoordinates};
    ...
    for (int i = 0; i < emptyRowsAndColumns[1].size(); i++)
    {
        for (int j = 0; j < galaxyCoordinates.size(); j++)
        {
            ...
            {
                expandedGalaxyCoordinates[j].second += expansionParameter;
            }
        }
    }
    ...
    for (int i = 0; i < emptyRowsAndColumns[0].size(); i++)
    {
        for (int j = 0; j < galaxyCoordinates.size(); j++)
        {
            ...
            {
                expandedGalaxyCoordinates[j].first += expansionParameter;
            }
        }
    }
...
long long manhattanDistance(const std::pair<long long,long long>& point1, const std::pair<long long,long long>& point2)
{
...
int main(int argc, char const *argv[])
{
    ...
    std::vector<std::pair<long long,long long>> galaxyCoordinates {findGalaxies(galaxyMap)};

    // Expand universe
    std::vector<std::pair<long long,long long>> expandedGalaxyCoordinates {expandUniverse(galaxyCoordinates, emptyRowsAndColumns)};
